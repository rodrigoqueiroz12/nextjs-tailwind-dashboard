    ...
    <SelectPrimitive.Root {...props}>
      ...
      <SelectPrimitive.Portal>
        <SelectPrimitive.Content
          ...
          position="popper"
          sideOffset={8}
          className="z-10 w-[--radix-select-trigger-width] animate-slideDownAndFade overflow-hidden rounded-lg border border-zinc-200 bg-white shadow-sm outline-none dark:border-zinc-700 dark:bg-zinc-800"
        >
