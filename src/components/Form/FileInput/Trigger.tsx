  ...
  return (
    <label
      ...
      className={twMerge(
        ...
        'dark:border-zinc-800 dark:hover:border-zinc-700 dark:hover:bg-zinc-700 dark:hover:text-violet-300',
      )}
    >
      <div
        className={twMerge(
          'rounded-full border-6 border-zinc-50 bg-zinc-100 p-2 group-hover:border-violet-50 group-hover:bg-violet-100',
          'dark:border-zinc-700 dark:bg-zinc-700 dark:group-hover:border-zinc-600 dark:group-hover:bg-zinc-700',
        )}
      >
        <UploadCloud
          className={twMerge(
            'h-5 w-5 text-zinc-600 group-hover:text-violet-700',
