          ...
          <div className="flex flex-col gap-3 lg:grid lg:grid-cols-form">
            ...
            <div className="flex flex-col gap-6 lg:grid lg:grid-cols-2">
              ...
              <div className="flex flex-col gap-3 lg:block">
                <label
                  htmlFor="lastName"
                  className="sr-only text-sm font-medium text-zinc-700 dark:text-zinc-300"
                >
                  Surname
                </label>

                <InputRoot>
                  <InputControl id="lastName" defaultValue={'Queiroz'} />
                </InputRoot>
              </div>
            </div>
          </div>
          ...
          <div className="flex flex-col gap-3 pt-5 lg:grid lg:grid-cols-form">
            ...
            <InputRoot>
              ...
              <InputControl
                id="email"
                type="email"
                defaultValue={'rodrigo.queiroz0629@gmail.com'}
              />
            </InputRoot>
          </div>
